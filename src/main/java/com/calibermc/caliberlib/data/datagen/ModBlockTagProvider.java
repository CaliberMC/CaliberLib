            ...
            for (Map.Entry<BlockManager.BlockAdditional, Pair<ResourceLocation, Supplier<Block>>> e : sortedBlocks) {
                ...
                if (Arrays.stream(RecipeStoneTypes.values()).anyMatch(p -> blockManager.getName().contains(p.getName()))) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (Arrays.stream(RecipeWoodTypes.values()).anyMatch(p -> blockManager.getName().contains(p.getName()))
                    ...
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.MINEABLE_WITH_AXE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if ((!blockName.contains("stone") && !(blockName.contains("sanded")) && (blockName.contains("clay") || blockName.contains("dirt")
                    ...
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.MINEABLE_WITH_SHOVEL).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (blockName.contains("leaves") || blockName.contains("thatch")) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.MINEABLE_WITH_HOE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }

                if (variant.equals(ModBlockFamily.Variant.ARCH)) {
                    this.tag(ModTags.Blocks.ARCHES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                ...
                if (variant.equals(ModBlockFamily.Variant.ARCH_HALF)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.HALF_ARCHES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ARCH_LARGE)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.LARGE_ARCHES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ARCH_LARGE_HALF)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.HALF_LARGE_ARCHES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ARROWSLIT)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.ARROWSLITS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BALUSTRADE)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.BALUSTRADES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BEAM_DIAGONAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.DIAGONAL_BEAMS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BEAM_HORIZONTAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.HORIZONTAL_BEAMS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BEAM_LINTEL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.BEAM_LINTELS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BEAM_POSTS)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.BEAM_POSTS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BEAM_VERTICAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.VERTICAL_BEAMS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BUTTON)) {
                    if (blockName.contains("limestone")) {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.STONE_BUTTONS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(BlockTags.WOODEN_BUTTONS).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(BlockTags.WOODEN_BUTTONS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.CAPITAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.CAPTIALS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
...
//                    } else {
//                        this.tag(ModTags.Blocks.COLUMNS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
//                    }
//                }
                ...
                if (variant.equals(ModBlockFamily.Variant.CORNER)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.CORNERS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.CORNER_SLAB)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.CORNER_SLABS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.CORNER_SLAB_VERTICAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.VERTICAL_CORNER_SLABS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.DOOR)) {
                    if ((Arrays.stream(RecipeWoodTypes.values()).anyMatch(p -> blockManager.getName().contains(p.getName())))){
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.WOODEN_DOORS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(BlockTags.DOORS).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(BlockTags.DOORS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                ...
                if (variant.equals(ModBlockFamily.Variant.DOOR_FRAME)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.DOOR_FRAMES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.DOOR_FRAME_LINTEL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.DOOR_FRAME_LINTELS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.EIGHTH)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.EIGHTHS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.FENCE)) {
                    if (Arrays.stream(RecipeWoodTypes.values()).anyMatch(p -> blockName.contains(p.getName()))) {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.WOODEN_FENCES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(BlockTags.FENCES).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(BlockTags.FENCES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.FENCE_GATE)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.FENCE_GATES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.HANGING_SIGN)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.CEILING_HANGING_SIGNS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.LAYER)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.LAYERS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.LAYER_VERTICAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.VERTICAL_LAYERS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.PILLAR)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.PILLARS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.PRESSURE_PLATE)) {
                    if (blockName.contains("limestone")) {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.STONE_PRESSURE_PLATES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(BlockTags.WOODEN_PRESSURE_PLATES).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(BlockTags.WOODEN_PRESSURE_PLATES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.QUARTER)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.QUARTERS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.QUARTER_VERTICAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.VERTICAL_QUARTERS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ROOF_22)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.ROOF_22S).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ROOF_45)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.ROOF_45S).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ROOF_67)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.ROOF_67S).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.ROOF_PEAK)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.ROOF_PEAKS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.SIGN)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.STANDING_SIGNS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.SLAB_VERTICAL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.VERTICAL_SLABS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.SLAB)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.SLABS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.STAIRS)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.STAIRS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.TALL_DOOR)) {
                    if ((Arrays.stream(RecipeWoodTypes.values()).anyMatch(p -> blockManager.getName().contains(p.getName())))){
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(ModTags.Blocks.TALL_WOODEN_DOORS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(ModTags.Blocks.TALL_IRON_DOORS).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(ModTags.Blocks.TALL_IRON_DOORS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                ...
                if (variant.equals(ModBlockFamily.Variant.TRAPDOOR)) {
                    if ((Arrays.stream(RecipeWoodTypes.values()).anyMatch(p -> blockManager.getName().contains(p.getName())))){
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.WOODEN_TRAPDOORS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(BlockTags.TRAPDOORS).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(BlockTags.TRAPDOORS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.WALL_HANGING_SIGN)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.WALL_HANGING_SIGNS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.WALL_SIGN)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.WALL_SIGNS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.WALL)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(BlockTags.WALLS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.WINDOW)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.WINDOWS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.WINDOW_HALF)) {
                    if (namespace != null && namespace.getNamespace().equals("caliber")) {
                        ...
                        this.tag(ModTags.Blocks.HALF_WINDOWS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                    }
                }
                ...
                if (variant.equals(ModBlockFamily.Variant.BASE)) {
                    if ((blockName.contains("granite") || blockName.contains("limestone") || blockName.contains("marble"))
                        ...
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.BASE_STONE_OVERWORLD).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                            this.tag(BlockTags.STONE_ORE_REPLACEABLES).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                            this.tag(Tags.Blocks.ORE_BEARING_GROUND_STONE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                        if (blockName.contains("granite")) {
                            if (namespace != null && namespace.getNamespace().equals("caliber")) {
                                this.tag(ModTags.Blocks.GRANITE).add(e.getValue().getSecond().get());
                            } else {
                                this.tag(ModTags.Blocks.GRANITE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                            }
                        } else if (blockName.contains("marble")) {
                            if (namespace != null && namespace.getNamespace().equals("caliber")) {
                                this.tag(ModTags.Blocks.MARBLE).add(e.getValue().getSecond().get());
                            } else {
                                this.tag(ModTags.Blocks.MARBLE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                            }
                        }
                        ...
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.PLANKS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else if (blockName.contains("bricks")) {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(BlockTags.STONE_BRICKS).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(BlockTags.STONE_BRICKS).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                        ...
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            ...
                            this.tag(BlockTags.LOGS_THAT_BURN).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    } else if (blockName.contains("sandstone")) {
                        if (namespace != null && namespace.getNamespace().equals("caliber")) {
                            this.tag(Tags.Blocks.SANDSTONE).add(e.getValue().getSecond().get());
                        } else {
                            this.tag(Tags.Blocks.SANDSTONE).addOptional(ResourceLocation.fromNamespaceAndPath(modid, e.getValue().getFirst().getPath()));
                        }
                    }
                }
