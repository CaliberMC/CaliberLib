...
//                        .texture("top", top)
//                        .texture("bottom", bottom),
//                beam_diagonal_1_ahv = models().withExistingParent(name(block) + "_1_ahch", modLoc("block/templates/beam_diagonal_1_ahv"))
//                        .texture("side", side)
//                        .texture("top", top)
//                        .texture("bottom", bottom),
...
//                        .texture("bottom", bottom),
                ...
                beam_diagonal_1_cv = models().withExistingParent(name(block) + "_1_cv", modLoc("block/templates/beam_diagonal_1_cv"))
                        ...
                        .texture("top", top)
                        .texture("bottom", bottom),
                beam_diagonal_2 = models().withExistingParent(name(block) + "_2", modLoc("block/templates/beam_diagonal_2"))
                        .texture("side", side)
                        .texture("top", top)
                        .texture("bottom", bottom),
                ...
                beam_diagonal_2_ahav = models().withExistingParent(name(block) + "_2_ahav", modLoc("block/templates/beam_diagonal_2_ahav"))
                        ...
                        .texture("top", top)
                        .texture("bottom", bottom),
                beam_diagonal_2_ahavdhdv = models().withExistingParent(name(block) + "_2_ahavdhdv", modLoc("block/templates/beam_diagonal_2_ahavdhdv"))
                        .texture("side", side)
                        .texture("top", top)
                        .texture("bottom", bottom),
        ...
        getVariantBuilder(block)
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.NORTH).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 1)
                .modelForState().modelFile(beam_diagonal_1_ahav).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.NORTH).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 2)
                .modelForState().modelFile(beam_diagonal_2_ahavdhdv).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.EAST).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 1)
                .modelForState().modelFile(beam_diagonal_1_ahav).rotationY(90).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.EAST).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 2)
                .modelForState().modelFile(beam_diagonal_2_ahavdhdv).rotationY(90).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.SOUTH).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 1)
                .modelForState().modelFile(beam_diagonal_1_ahav).rotationY(180).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.SOUTH).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 2)
                .modelForState().modelFile(beam_diagonal_2_ahavdhdv).rotationY(180).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.WEST).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 1)
                .modelForState().modelFile(beam_diagonal_1_ahav).rotationY(270).addModel()
                ...
                .partialState().with(DiagonalBeamBlock.FACING, Direction.WEST).with(DiagonalBeamBlock.CONNECT, BeamConnection.AH_AV_DH_DV).with(DiagonalBeamBlock.BEAM, 2)
                .modelForState().modelFile(beam_diagonal_2_ahavdhdv).rotationY(270).addModel()
